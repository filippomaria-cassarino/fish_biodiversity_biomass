...
Data from external sources data are subject to the respective terms and conditions of their providers and are not covered by the repository's software licence. Users should consult the original data providers' terms before accessing, using, or redistributing these datasets.

Data generated by the authors are made available under CC BY 4.0.

All code developed for this study is made available under the MIT License.
