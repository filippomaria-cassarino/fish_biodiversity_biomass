...
## Date last modified:  17 jul 2025

## Description:
# This script explores and filters the original community data

## NOTES
# 1 move mapping_objects code
# 2 use new equal area projection (better for mapping with grids rather than points)
