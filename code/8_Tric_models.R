...
boxplot(check_data$Tric, horizontal = TRUE) # no majour outliers
plot(density(check_data$Tric)) # use gaussian distribution in modelling
...
# Selection
all_model <- model_selection(directory = "models/Tric/all/no_fishing",
                             name = "all",
                             data = all_data,
                             mesh_cutoff = 65, 
...
model_validation(model = all_model,
                 data = all_data,
                 directory = "models/Tric/all/no_fishing")
...
# Variables distribution and out-liers were assessed in 6_biomass_models.R
boxplot(arctic_data$Tric, horizontal = TRUE) # no majour outliers
plot(density(arctic_data$Tric)) # use gaussian distribution in modelling
...
model_validation(model = arctic_model,
                 data = arctic_data,
                 directory = "models/Tric/arctic/no_fishing")
...
# Variables distribution and out-liers were assessed in 6_biomass_models.R
boxplot(boreal_data$Tric, horizontal = TRUE) # no majour outliers
plot(density(boreal_data$Tric)) # use gaussian distribution in modelling
...
# Selection
boreal_model <- model_selection(directory = "models/Tric/boreal/no_fishing",
                                name = "boreal",
                                data = boreal_data,
                                mesh_cutoff = 65, 
                                family = gaussian(link = "identity"),
...
model_validation(model = boreal_model,
                 data = boreal_data,
                 directory = "models/Tric/boreal/no_fishing")
...
boxplot(check_data$Tric, horizontal = TRUE) # no majour outliers
plot(density(check_data$Tric)) # use gaussina distribution in modelling
...
# Selection
all_model <- model_selection(directory = "models/Tric/all/with_fishing",
                             name = "all",
                             data = all_data,
                             mesh_cutoff = 65, 
                             family = gaussian(link = "identity"),
...
model_validation(model = all_model,
                 data = all_data,
                 directory = "models/Tric/all/with_fishing")
...
# Selection
arctic_model <- model_selection(directory = "models/Tric/arctic/with_fishing",
                                name = "arctic",
                                data = arctic_data,
                                mesh_cutoff = 65, 
                                family = gaussian(link = "identity"),
...
model_validation(model = arctic_model,
                 data = arctic_data,
                 directory = "models/Tric/arctic/with_fishing")
...
# Selection
boreal_model <- model_selection(directory = "models/Tric/boreal/with_fishing",
                                name = "boreal",
                                data = boreal_data,
                                mesh_cutoff = 65, 
                                family = gaussian(link = "identity"),
...
model_validation(model = boreal_model,
                 data = boreal_data,
                 directory = "models/Tric/boreal/with_fishing")
